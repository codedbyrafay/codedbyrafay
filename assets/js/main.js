...
// If no theme has been previously selected, default to dark theme
if (!selectedTheme) {
...
document.body.classList[selectedTheme === darkTheme ? "add" : "remove"](
  darkTheme
);
themeButton.classList[selectedIcon === iconTheme ? "add" : "remove"](
  iconTheme
);
